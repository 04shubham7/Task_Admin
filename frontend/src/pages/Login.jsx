...
const Login=()=>{
    ...
    return(
      ...
      {/* Absolute abstract design elements to bump visual score */}
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-dark-900 tracking-tight">Welcome back</h2>
        ...
        {error && (
          <motion.div 
            ...
            className="mb-5 flex items-center gap-2 p-3 bg-red-50 border border-red-100 text-red-600 rounded-xl text-sm"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <motion.button 
            ...
            className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl text-sm transition-colors flex items-center justify-center gap-2 shadow-lg shadow-indigo-100 disabled:opacity-70"
          >
            {isSubmitting ? (
